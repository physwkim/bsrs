...
//! drives [`bsrs_engine::RunEngine`] for plan execution.
//!
...
//!
//! ```ignore
//! use bsrs_qs::{Server, Registry};
//! use bsrs_backend_soft::SoftDetector;
//! use std::sync::Arc;
//!
//! # async fn run() -> bsrs_core::error::Result<()> {
//! let det = SoftDetector::new("det1");
//! let mut reg = Registry::new();
//! reg.register_readable("det1", det as Arc<dyn bsrs_core::msg::ReadableObj>);
