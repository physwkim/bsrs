...
use bsrs_core::lua_exposable::LuaMethodEntry;
use bsrs_core::msg::{
...
impl Registry {
    ...
    /// exposure. Devices that implement `bsrs_core::LuaExposable`
    /// (auto-generated by `#[lua_methods]`) call this once after
    /// registering their roles, passing their `Arc<Self>` and
    /// `Self::lua_methods()`.
    pub fn register_lua_methods<T: bsrs_core::LuaExposable + 'static>(
        &mut self,
