...
use crate::event_model::{DataKey, StreamDatum, StreamResource};
...
/// lives alongside [`WatcherUpdate`](crate::core::status::WatcherUpdate) and
/// [`Status`] so a status can drive it directly via
/// [`observe_watcher`](crate::core::status::Status::observe_watcher). A
/// `LiveTable` / progress bar implements this.
pub use crate::core::status::Watcher;
