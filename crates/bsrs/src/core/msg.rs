...
pub type SubscribeCallback = Arc<dyn Fn(&crate::event_model::Document) + Send + Sync + 'static>;
...
pub enum Msg {
    ...
    Subscribe {
        ...
        filter: crate::event_model::DocFilter,
    },
...
fn document_label(d: &crate::event_model::Document) -> &'static str {
...
pub trait ReadableObj: NamedObj {
    ...
    async fn read_dyn(
        &self,
    ) -> Result<HashMap<String, crate::core::reading::ReadingValue>, crate::core::error::BsrsError>;
    /// Describe each field.
...
pub trait MovableObj: NamedObj {
    ...
    async fn set_dyn(&self, value: f64) -> crate::core::status::Status;
...
pub trait StoppableObj: NamedObj {
    ...
    async fn stop_dyn(&self, success: bool) -> Result<(), crate::core::error::BsrsError>;
}
...
pub trait TriggerableObj: NamedObj {
    ...
    async fn trigger_dyn(&self) -> crate::core::status::Status;
}
...
/// Object-safe analogue of [`crate::core::ext`]'s `Preparable` trait.
#[async_trait::async_trait]
pub trait PreparableObj: NamedObj {
    /// Prepare; returned `Status` resolves when the device is ready.
    async fn prepare_dyn(&self, value: Value) -> crate::core::status::Status;
}
...
pub trait CollectableObj: NamedObj {
    ...
    async fn describe_collect_dyn(
        ...
        HashMap<String, HashMap<String, crate::event_model::DataKey>>,
