...
//! emitted by a [`crate::callbacks::ZmqDocumentSink`] and re-broadcast them
...
//! ```ignore
//! use std::sync::Arc;
//! use crate::callbacks::{Serializer, ZmqDocumentSource};
//! use crate::engine::RunEngine;
//!
//! # async fn ex(re: Arc<RunEngine>) -> crate::core::Result<()> {
...
pub use crate::callbacks::zmq_sink::Serializer;
