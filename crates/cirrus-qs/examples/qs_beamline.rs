//! Example cirrus-qs daemon. Registers a few soft devices and the `count`
...
#[tokio::main]
async fn main() -> cirrus_core::error::Result<()> {
    ...
    println!("[cirrus-qs] starting on tcp://*:60615 (control), tcp://*:60625 (documents)");
