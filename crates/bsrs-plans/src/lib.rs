...
pub mod stubs {
    ...
    pub fn declare_stream(
        ...
        data_keys: std::collections::HashMap<String, bsrs_event_model::DataKey>,
    ) -> Plan {
        let stream_name = stream_name.into();
        plan_box(async_stream::stream! {
...
mod tests {
    ...
    impl bsrs_core::msg::NamedObj for FakePreparable {
        fn name(&self) -> &str {
            &self.0
        }
    }
    ...
    use bsrs_core::msg::{DynLocation, MovableObj, NamedObj, ReadableObj};
    ...
    #[async_trait::async_trait]
    impl bsrs_core::msg::LocatableObj for FakeMotor {
        async fn locate_dyn(&self) -> Result<DynLocation, bsrs_core::error::BsrsError> {
            Ok(DynLocation {
                setpoint: self.bias,
                readback: self.bias,
            })
    ...
    #[async_trait::async_trait]
    impl bsrs_core::msg::LocatableObj for CountingMotor {
        async fn locate_dyn(&self) -> Result<DynLocation, bsrs_core::error::BsrsError> {
            self.locates
    ...
    impl ReadableObj for FakeReadable {
        async fn read_dyn(
            &self,
        ) -> Result<HashMap<String, ReadingValue>, bsrs_core::error::BsrsError> {
            Ok(HashMap::new())
        }
        async fn describe_dyn(
            &self,
        ) -> Result<HashMap<String, bsrs_event_model::DataKey>, bsrs_core::error::BsrsError>
        {
            Ok(HashMap::new())
        }
    }
    ...
    async fn rel_log_scan_offsets_log_spaced_targets_by_current_readback() {
        ...
        let motor = Arc::new(FakeMotor {
            name: "m".into(),
            bias: 10.0,
        }) as Arc<dyn bsrs_core::msg::LocatableObj>;
    ...
    fn motor_xy(
        ...
        Arc<dyn bsrs_core::msg::LocatableObj>,
        Arc<dyn bsrs_core::msg::LocatableObj>,
    ) {
        (
            Arc::new(FakeMotor {
    ...
    async fn relative_set_locates_only_motors_the_plan_moves() {
        ...
        let msgs = drain(preprocessors::relative_set_wrapper(
            inner,
            vec![
                moved as Arc<dyn bsrs_core::msg::LocatableObj>,
                unmoved as Arc<dyn bsrs_core::msg::LocatableObj>,
            ],
        ))
        .await;
        assert_eq!(
    ...
    async fn relative_moves_base_on_setpoint_not_readback() {
        ...
        #[async_trait::async_trait]
        impl bsrs_core::msg::LocatableObj for SplitMotor {
            async fn locate_dyn(&self) -> Result<DynLocation, bsrs_core::error::BsrsError> {
                Ok(DynLocation {
                    setpoint: 5.0,
                    readback: 4.0,
        ...
        let motor: Arc<dyn bsrs_core::msg::LocatableObj> = Arc::new(SplitMotor);
